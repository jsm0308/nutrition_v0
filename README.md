...
> 급식·재료·영양 목표를 동시에 만족하는
> 최적 식단을 자동 생성하는 웹 서비스**
...
단순한 건강식 추천이 아니라,
**연령별 권장 섭취량과 실제 섭취량의 격차**를 정량화하여
식단 개입 효과가 가장 큰 타겟 집단을 선정하고
이를 위한 **영양 최적화 추천 시스템**을 구축하였다.
...
사용자는
학교 정보·집 재료·금지 식품만 입력하면
**급식에 맞춰 조정된 하루 식단**을 제공받는다.
